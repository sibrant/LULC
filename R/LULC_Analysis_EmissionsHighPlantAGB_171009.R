install.packages(c('rgdal', 'rgeos', 'sp', 'gdalUtils', 'raster', 'maptools', 'qdapTools'))
...
cci = read.csv('g:/Agrimetrics/Unilever_PalmOil/DataAnalysis/EmissionConversionTable_CCI_2.csv')
crisp = read.csv('g:/Agrimetrics/Unilever_PalmOil/DataAnalysis/EmissionConversionTable_CRISP_3.csv')
mof = read.csv('g:/Agrimetrics/Unilever_PalmOil/DataAnalysis/EmissionConversionTable_MoF_2.csv')
...
#make subset for Kalten, Riau, Sumuta for MoF, CCI & CRISP
      ...
      if (grepl('MoF', lab0)) {
        ...
        if (length(freqt01change > 0)) {
          ...
          if (length(shplist > 0)) {
            ...
            #write to CSV
            write.csv(lulctable, paste0(k, '/LULCC_MapTable/LULCC_Table_',lulc,'_',aoi,'_',yr0,'_',yr1,'_HighPlantationAGB.csv'))
            ...
            write('\n', paste0(k, '/LULCC_MapTable/LULCC_Table_',lulc,'_',aoi,'_',yr0,'_',yr1,'_HighPlantationAGB.csv'), append=T)
            write(headline, paste0(k, '/LULCC_MapTable/LULCC_Table_',lulc,'_',aoi,'_',yr0,'_',yr1,'_HighPlantationAGB.csv'), append=T)
            write(sumline, paste0(k, '/LULCC_MapTable/LULCC_Table_',lulc,'_',aoi,'_',yr0,'_',yr1,'_HighPlantationAGB.csv'), append=T)
            write(yrline, paste0(k, '/LULCC_MapTable/LULCC_Table_',lulc,'_',aoi,'_',yr0,'_',yr1,'_HighPlantationAGB.csv'), append=T)
            write(percline, paste0(k, '/LULCC_MapTable/LULCC_Table_',lulc,'_',aoi,'_',yr0,'_',yr1,'_HighPlantationAGB.csv'), append=T)
            ...
            #write to CSV
            write.csv(lulctable, paste0(k, '/LULCC_MapTable/LULCC_Table_',lulc,'_',aoi,'_',yr0,'_',yr1,'_HighPlantationAGB2.csv'))
            ...
            write('\n', paste0(k, '/LULCC_MapTable/LULCC_Table_',lulc,'_',aoi,'_',yr0,'_',yr1,'_HighPlantationAGB2.csv'), append=T)
            write(sumline, paste0(k, '/LULCC_MapTable/LULCC_Table_',lulc,'_',aoi,'_',yr0,'_',yr1,'_HighPlantationAGB2.csv'), append=T)
            write(yrline, paste0(k, '/LULCC_MapTable/LULCC_Table_',lulc,'_',aoi,'_',yr0,'_',yr1,'_HighPlantationAGB2.csv'), append=T)
        ...
        #   writeRaster(t01emiss, paste0(k,'/GHG_Map/GHG_Map_',lulc,'_',aoi,'_',yr0,'_',yr1,'.tif'), overwrite=T)
           print(paste0(Sys.time(),' GHG_Map_',lulc,'_',aoi,'_',yr0,'_',yr1,'.tif'))
        #   
...
#make subset of CCI 2000, 2005, 2010 and 2015
cliplist = cliplist[c(9, 14,19,24)]

#make subset of MoF 2000, 2006, 2011 and 2015
cliplist = cliplist[c(3,5,7,10)]
